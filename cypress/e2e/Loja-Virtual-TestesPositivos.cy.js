...
describe('Validar que um produto pode ser adicionado, com sucesso, ao carrinho', function () {
  ...
  it('Acessar a pagina inicial VR Beneficios', function () {
    ...
    cy.get('#escolha-modalidade > .page-section-container__holder > .lojavr-style-c-eThXxq > .lojavr-style-c-eDZtRs > .lojavr-style-c-PKtiO').should('have.text', 'A VR tem tudo que sua empresa precisa!')
